...
describe('PlayerSetup', () => {
	...
	it('should dispatch jwpSetup action without strategy rules flag when strategy rules are disabled', () => {
	...
	it('should dispatch jwpSetup action with strategy rules flag when strategy rules are enabled', () => {
