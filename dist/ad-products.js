...
defineProperty_default()(stickiness_Stickiness, "LOG_GROUP", 'stickiness');

defineProperty_default()(stickiness_Stickiness, "STICKINESS_CHANGE_EVENT", Symbol('stickinessChange'));

defineProperty_default()(stickiness_Stickiness, "CLOSE_CLICKED_EVENT", Symbol('closeClicked'));

defineProperty_default()(stickiness_Stickiness, "UNSTICK_IMMEDIATELY_EVENT", Symbol('unstickImmediately'));

defineProperty_default()(stickiness_Stickiness, "SLOT_STICKED_STATE", 'sticked');

defineProperty_default()(stickiness_Stickiness, "SLOT_UNSTICKED_STATE", 'unsticked');

defineProperty_default()(stickiness_Stickiness, "SLOT_STICKY_READY_STATE", 'sticky-ready');

defineProperty_default()(stickiness_Stickiness, "SLOT_UNSTICK_IMMEDIATELY", 'force-unstick');

defineProperty_default()(stickiness_Stickiness, "SLOT_STICKINESS_DISABLED", 'stickiness-disabled');
...
var icons = __webpack_require__(13);
...
defineProperty_default()(sticky_base_StickyBase, "DEFAULT_UNSTICK_DELAY", 2000);
...
defineProperty_default()(hivi_theme_BigFancyAdHiviTheme, "DEFAULT_UNSTICK_DELAY", 3000);
...
defineProperty_default()(hivi_bfaa_BfaaHiviTheme, "RESOLVED_STATE_EVENT", Symbol('RESOLVED_STATE_EVENT'));
...
defineProperty_default()(jwplayer_tracker_JWPlayerTracker, "PLAYER_NAME", 'jwplayer');
