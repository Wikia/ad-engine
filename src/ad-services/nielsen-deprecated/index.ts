...
/**
 * Creates NielsenDeprecated Static Queue Snippet
 */
...
/**
 * NielsenDeprecated service handler
 */
class NielsenDeprecated extends BaseServiceSetup {
	...
	/**
	 * Create NielsenDeprecated Static Queue and make a call
	 * @returns {Object}
	 */
	call(): void {
...
export const nielsenDeprecated = new NielsenDeprecated();
