...
class IasPublisherOptimizationDeprecated extends BaseServiceSetup {
	...
	private iasDataHandler(adSlotData: string): void {
		...
		IasPublisherOptimizationDeprecated.setBrandSafetyKeyValuesInTargeting(
			iasTargetingData.brandSafety,
		);
		IasPublisherOptimizationDeprecated.setCustomKeyValuesInTargeting(iasTargetingData.custom);
...
export const iasPublisherOptimizationDeprecated = new IasPublisherOptimizationDeprecated();
