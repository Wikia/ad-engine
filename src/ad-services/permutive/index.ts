...
class Permutive {
	...
	private getPageViewEventSchema(): object {
		const pageInfo = {
			...
			'age': context.get('targeting.adTags.age'),
			'sex': context.get('targeting.sex'),
			'gnre': context.get('targeting.adTags.gnre'),
			'media': context.get('targeting.adTags.media'),
			'pform': context.get('targeting.adTags.pform'),
			'pub': context.get('targeting.pub'),
			'theme': context.get('targeting.adTags.theme'),
