...
import { getReplayIcon } from "../../../../../ad-products/templates/interface/icons/replay";
...
function addReplayIcon(overlay: HTMLElement): HTMLElement | null {
	const replayIcon = getReplayIcon(['replay-icon', 'overlay-icon']);
...
function addPlayIcon(overlay): HTMLElement | null {
	const playIcon = getPlayIcon(['play-icon', 'overlay-icon']);
