			...
			bids: [
				{
					...
					labelAll: ['desktop'],
					params: {
						zoneId: 32563810, //only mandatory field
				...
				},
				{
					...
					labelAll: ['phone'],
					params: {
						zoneId: 32563826, //only mandatory field
	...
	addBids(bidRequest, addBidResponse, done): void {
		setTimeout(async () => {
			...
			bidRequest.bids.forEach((bid) => {
				...
				bidResponse.creativeId = 'foo123_wikiaVideoCreativeId'; // TODO freewheel
				bidResponse.ttl = 300;
				bidResponse.mediaType = 'video';
				bidResponse.width = width;
				bidResponse.height = height;
				bidResponse.vastUrl = Freewheel.getVastUrl(width, height, slotName);
				bidResponse.videoCacheKey = '123foo_wikiaVideoCacheKey'; // TODO freewheel
