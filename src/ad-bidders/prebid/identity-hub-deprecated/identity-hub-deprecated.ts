...
const logGroup = 'IdentityHubDeprecated';

class IdentityHubDeprecated extends BaseServiceSetup {
	...
	call(): Promise<void> {
		...
		if (!this.isLoaded) {
			// PWT.jsLoaded() is part of Pubmatic script, it's called when IdentityHubDeprecated is ready
...
export const identityHubDeprecated = new IdentityHubDeprecated();
