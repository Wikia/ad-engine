export const fallbackInstantConfig = {
	...
	icConfiant: [{ apps: ['gamepedia'], value: true }],
	wgAdDriverUapRestriction: 1,
	icBTRec: [{ apps: ['gamepedia'], devices: ['desktop'], regions: ['XX'], value: true }],
	...
	icTaxonomyAdTags: [{ apps: ['gamepedia'], regions: ['XX'], value: true }],
	icBabDetection: [
		{ apps: ['f2', 'gamepedia', 'mobile-wiki', 'oasis'], regions: ['XX'], value: true },
	],
	wgAdDriverA9DealsCountries: ['XX'],
	wgAdDriverOutstreamSlotCountries: null,
