...
export * from './setup/gpt-deprecated.setup';
export * from './setup/gpt.setup';
export * from './setup/player-experiment-deprecated.setup';
export * from './setup/player.setup';
export * from './setup/player-deprecated.setup';
...
export * from './services/wad-runner-deprecated';
