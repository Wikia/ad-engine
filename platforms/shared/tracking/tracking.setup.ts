...
const loadTimeTrackingUrl = 'https://beacon.wikia-services.com/__track/special/adengloadtimeinfo';
				...
				dataWarehouseTracker.track(
					{
						...
						load_time: eventInfo.timestamp, // TODO calculate as starting point - timestamp
					},
					loadTimeTrackingUrl,
				);
			},
